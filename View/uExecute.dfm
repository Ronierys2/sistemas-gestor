    ...
    object TabSheet4: TTabSheet
      ...
      object MemoNovo: TMemo
        ...
        Lines.Strings = (
          ...
          ''
          'ALTER TABLE PESSOA ALTER CNPJ DROP NOT NULL;'
          ''
          'ALTER TABLE PESSOA ALTER IE  DROP NOT NULL;'
          ''
          'ALTER TABLE PESSOA ALTER ENDERECO DROP NOT NULL;'
          ''
          'ALTER TABLE PESSOA ALTER NUMERO DROP NOT NULL;'
          ''
          'ALTER TABLE PESSOA ALTER CODMUN DROP NOT NULL;'
          ''
          'ALTER TABLE PESSOA ALTER MUNICIPIO DROP NOT NULL;'
          ''
          'ALTER TABLE PESSOA ALTER BAIRRO DROP NOT NULL;'
          ''
          'ALTER TABLE PESSOA ALTER CEP DROP NOT NULL;'
          ''
          'ALTER TABLE PESSOA ALTER UF DROP NOT NULL;'
          ''
          'ALTER TABLE PESSOA ALTER FANTSASIA DROP NOT NULL;')
        ReadOnly = True
    ...
    object TabSheet11: TTabSheet
      ...
      object MemoUpdate: TMemo
        ...
        Lines.Strings = (
          ...
          'SET TERM ;^'
          ''
          'CREATE FUNCTION REMOVE_ACENTOS (TEXTO VARCHAR(255))'
          'RETURNS VARCHAR(255)'
          'AS'
          'BEGIN'
          '  TEXTO = REPLACE(TEXTO, '#39#193#39','#39'A'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#192#39','#39'A'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#194#39','#39'A'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#195#39','#39'A'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#196#39','#39'A'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#225#39','#39'a'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#224#39','#39'a'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#226#39','#39'a'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#227#39','#39'a'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#228#39','#39'a'#39');'
          ''
          '  TEXTO = REPLACE(TEXTO, '#39#201#39','#39'E'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#200#39','#39'E'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#202#39','#39'E'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#203#39','#39'E'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#233#39','#39'e'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#232#39','#39'e'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#234#39','#39'e'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#235#39','#39'e'#39');'
          ''
          '  TEXTO = REPLACE(TEXTO, '#39#205#39','#39'I'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#204#39','#39'I'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#206#39','#39'I'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#207#39','#39'I'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#237#39','#39'i'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#236#39','#39'i'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#238#39','#39'i'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#239#39','#39'i'#39');'
          ''
          '  TEXTO = REPLACE(TEXTO, '#39#211#39','#39'O'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#210#39','#39'O'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#212#39','#39'O'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#213#39','#39'O'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#214#39','#39'O'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#243#39','#39'o'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#242#39','#39'o'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#244#39','#39'o'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#245#39','#39'o'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#246#39','#39'o'#39');'
          ''
          '  TEXTO = REPLACE(TEXTO, '#39#218#39','#39'U'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#217#39','#39'U'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#219#39','#39'U'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#220#39','#39'U'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#250#39','#39'u'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#249#39','#39'u'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#251#39','#39'u'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#252#39','#39'u'#39');'
          ''
          '  TEXTO = REPLACE(TEXTO, '#39#199#39','#39'C'#39');'
          '  TEXTO = REPLACE(TEXTO, '#39#231#39','#39'c'#39');'
          ''
          '  RETURN TEXTO;'
          'END^'
          'SET TERM ;^'
          ''
          'CREATE TRIGGER TRG_CIDADE_BIUD_DESCRICAO'
          'FOR CIDADE'
          'ACTIVE BEFORE INSERT OR UPDATE'
          'AS'
          'BEGIN'
          '  NEW.DESCRICAO = REMOVE_ACENTOS(NEW.DESCRICAO);'
          'END^'
          'SET TERM ;^')
        ReadOnly = True
        ScrollBars = ssVertical
